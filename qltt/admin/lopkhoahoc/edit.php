<?php 
    ...
    $id = $_GET['id'];
    $listKTQuery = "select * from lopkhoahoc where id = $id";
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="row">
              ...
              <h3 class="box-title">Cập Nhật Lớp Khóa Học</h3>

            <!-- /.box-header -->
            <div class="box-body">
            <form action="<?= $ADMIN_URL ?>lopkhoahoc/save-edit.php" method="post">
        <div class="col-md-6">
