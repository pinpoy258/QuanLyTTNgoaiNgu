<?php 
    ...
    $id = $_GET['course_id'];
    $listRoomQuery = "select * from courses where id= $id";
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="row">
              ...
              <h3 class="box-title">Thêm bài giảng</h3>

            <!-- /.box-header -->
            <div class="box-body">
            <form action="<?= $ADMIN_URL ?>khoahoc/lesssave.php" method="post"  enctype="multipart/form-data">
        <div class="col-md-6">
