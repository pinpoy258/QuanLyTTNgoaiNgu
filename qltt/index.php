...
<!-- /WhatsHelp.io widget -->
        <div class="container-fluid py-4 bg-white">
             <div class="container py-4">
                    <h2  class="text-center">CHÀO MỪNG BẠN ĐẾN VỚI TRUNG TÂM </h2>
                 <div class="row py-4">
                     <div class="col-md-6">
         ...
         <div class="container-fluid py-4" style="background: #f7f7f7;">
                <div class="container py-4">
                       <h2  class="text-center">GIẢNG VIÊN CỦA TRUNG TÂM </h2>
                    <div class="row py-4">
            ...
            <div class="container-fluid py-4 bg-white">
                    <div class="container py-4">
                        <h2 class="text-center">KHÓA HỌC Tiếng Anh MỚI</h2>
                            <div class="row my-4">
